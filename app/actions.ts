...
export async function addTransactionToBudget(
    ...
    try {
        ...
        if (totalWhithNewTransaction > budget.amount) {
            throw new Error("Le montant total des transactions dépasse le budget alloué.");
        }
...
export async function getReachedBudgets(email: string){
    try {
        ...
        console.error("Erreur lors de la récupération des budgets atteints :", error);
        throw error;
    }
}
...
export async function getUserBudgetData(email: string) {
    try {
        ...
        console.error("Erreur lors de la récupération des données budgétaire :", error);
        throw error;
