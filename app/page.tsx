        ...
        <div>
          <div className="flex flex-col">
            ...
            <p className="py-6 text-gray-800 text-center">
              ...
              notre application intuitve
            </p>
            <div className="flex justify-center items-center">
              <Link
                href={"/sign-in"}
                className="btn btn-sm border-1 rounded-full md:btn-md btn-outline btn-accent"
              >
                Se connecter
              </Link>
              <Link
                href={"/sign-up"}
                className="btn btn-sm border-1 rounded-full md:btn-md btn-accent ml-2"
              >
                S&apos;inscrire
              </Link>
            </div>
